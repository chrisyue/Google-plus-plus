        ...
        $('.gpp-rs').each(function(i, dom) {
          ...
          if (self.preview != 1) {
            ...
            $('<img>').attr({
              ...
              'width': width,
              'height': height
            }).appendTo(prevLink).attr({'src': src});
          }
        });
      },
    },
